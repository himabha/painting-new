 ...
 */
function painting_customize( $wp_customize ) {
	/**
	 * Initialize sections
	 */
	...
	$wp_customize->add_control(
		new WP_Customize_Image_Control(
			...
			'header_logo',
			array(
				'label'       => __( 'Upload Header Logo', 'painting' ),
				'description' => __( 'Height: &gt;80px', 'painting' ),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar Scheme', 'painting' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'navbar-light bg-light'  => __( 'Default', 'painting' ),
				'navbar-dark bg-dark'    => __( 'Dark', 'painting' ),
				'navbar-dark bg-primary' => __( 'Primary', 'painting' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'radio',
			'label'    => __( 'Navbar', 'painting' ),
			'section'  => 'theme_header_section',
			'choices'  => array(
				'static'       => __( 'Static', 'painting' ),
				'fixed_top'    => __( 'Fixed to top', 'painting' ),
				'fixed_bottom' => __( 'Fixed to bottom', 'painting' ),
			),
	...
	$wp_customize->add_control(
		...
		array(
			'type'     => 'checkbox',
			'label'    => __( 'Show Searchfield?', 'painting' ),
			'section'  => 'theme_header_section',
 ...
 */
function painting_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'painting_customize_preview_js' );
