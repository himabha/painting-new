...
<body <?php body_class(); ?>>
	...
	<a href="#main" class="visually-hidden-focusable"><?php esc_html_e('Skip to main content', 'painting'); ?></a>
	...
	<div id="wrapper">
		<header>
			...
			<nav id="header" class="navbar navbar-expand-lg <?php echo esc_attr($navbar_scheme);
				...
				<div class="container-fluid">
					...
					<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'painting'); ?>">
						...
						?>
							<form class="search-form my-2 my-lg-0" role="search" method="get" action="<?php echo esc_url(home_url('/')); ?>">
								<div class="input-group">
									<input type="text" name="s" class="form-control" placeholder="<?php esc_attr_e('Search', 'painting'); ?>" title="<?php esc_attr_e('Search', 'painting'); ?>" />
									<button type="submit" name="submit" class="btn btn-outline-secondary"><?php esc_html_e('Search', 'painting'); ?></button>
								</div>
							</form>
						<?php
						endif;
		...
		<?= do_action('before_main_container'); ?>
